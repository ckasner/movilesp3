...
public class DatabaseAdapter {
    private static final String DEBUG_TAG = "DatabaseAdapter"; private static final String DATABASE_NAME = "ccc.db"; private static final int DATABASE_VERSION = 1;
    private DatabaseHelper helper;
    private SQLiteDatabase db;
    public DatabaseAdapter(Context context) { helper = new DatabaseHelper(context);
    }
